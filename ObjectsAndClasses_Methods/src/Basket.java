public class Basket {
    private static int totalBasketItems = 0;
    private static int totalBasketPrice = 0;
    private static double averageCost = 0;
    private static double averageBasketCost = 0;
    ...
    public void add(String name, int price, int count, double weight) {
        ...
        averageCost = totalBasketPrice / totalBasketItems;
        averageBasketCost = totalBasketPrice / Basket.count;
